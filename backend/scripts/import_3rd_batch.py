"""
第三批数据导入脚本（去重逻辑：company_id + call_date 相同则覆盖）
用法: python3.11 import_3rd_batch.py
"""
import sys
import pandas as pd
...
def read_xlsx(filepath):
    ...
    # 排除已导入的渠道商
    df = df[~df["channel_name"].isin(EXCLUDED_CHANNELS)]
...
def main():
    filepath = "/Users/aobuy/Documents/LLM/ViewPan/原数据/第三批数据.xlsx"
