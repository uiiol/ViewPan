"""
26年数据导入脚本（20260101-0408外呼数据统计.xlsx）
去重逻辑：company_id + call_date 相同则覆盖
用法: python3.11 import_26th.py
"""
import sys
import pandas as pd
...
def main():
    filepath = "/Users/aobuy/Documents/LLM/ViewPan/原数据/20260101-0408外呼数据统计.xlsx"
